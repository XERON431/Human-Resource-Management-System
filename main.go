...
const mongoURI = "mongodb+srv://siddhantgoyaliitg:Ul1id76XKkJudsAA@cluster0.f0bhwij.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
func Connect() error {
	...
	// Explicitly reference the database using dbName
...
func main() {
	...
	// Listen for OS signals for termination
	quit := make(chan os.Signal, 1)
	signal.Notify(quit, os.Interrupt, syscall.SIGTERM)
	<-quit

	// Shutdown the server and disconnect MongoDB client
